...
function getOverlayDetails(id, classCategory, category, title, description, dueDate, priority, prioIcon, allFiles) {
    ...
    <section class="content-overlay">
        ...
        <h3>${title}</h3>
        <p>${description}</p>
        <section class="due-date-overlay">
            <h4>Due date:</h4>
            <p>${dateFormatter(dueDate)}</p>
        </section>
        <section class="priority-overlay">
            <h4>Priority:</h4>
            <section class="priority-container-overlay">
                <p>${priority}</p>
        ...
        <section>
            ...
            <section class="attachments-overlay" id="attachments-overlay">
...
function getUserNamesOverlay(firstLetter, userName, color) {
    return `
    <section class="username-overlay">
...
function getAttachmentsOverlay(id, attachmentId, name, base64) {
    return `
    <section class="file" id="attachment-container">
...
function getOverlayEdit(id, title, description, dueDate) {
    return `
    <section class="content-overlay">
        <section class="header-overlay-edit">
            <div class ="close-overlay">
                <img onclick="closeOverlay()" class="close-icon" src="./assets/icons/close.svg" alt="close">
            </div>    
        </section>
        <section class="overlay-edit-container">
            <section class="overlay-edit-container">
            ...
            <section class="overlay-priority-container">
            ...
            <div class="date-input-container overlay-edit-container">
                <p>Attachments</p>
            <div class="date-input-field" onclick="handleContainerClick(event)">
            ...
            <section class="overlay-edit-container" id="subtask-add-container">
...
function getContactName(id, name, color, firstLetterFirstName, firstLetterLastName, urlIcon) {
    return `
    <section class="contact-container-overlay" onclick="toggleAssignedTo('${name}', ${id})">
...
function getUserInititalsOverlayEdit(color, firstLetter) {
    return `
    <section style="background-color: ${color};" class="assigned-user-overlay-edit">
        <p>${firstLetter}</p>
    </section>
    `
}
...
function getMoreUserOverlayEdit(userslength) {
    return `
    <section class="user-initials-overlay">
        <p>+ ${userslength}</p>
    </section>
    `
}
